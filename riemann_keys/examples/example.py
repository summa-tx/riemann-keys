...
print("xpub " + root.extended_public_key.hex())
print("xpriv " + root.extended_private_key.hex())
print("\n")
...
print("xpub " + node.extended_public_key.hex())
print("xpriv " + node.extended_private_key.hex())
